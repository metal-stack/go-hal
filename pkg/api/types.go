...
const (
	...
	VendorDell
	// VendorFujitsu identifies all Fujitsu servers
	VendorFujitsu
...
var (
	...
	allVendors = [...]Vendor{VendorSupermicro, VendorNovarion, VendorLenovo, VendorDell, VendorFujitsu, VendorVagrant, VendorUnknown, VendorGigabyte}
)
